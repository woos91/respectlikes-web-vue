...
<template>
<svg version="1.1" id="about_img_bg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 862 390" style="enable-background:new 0 0 862 390;" vector-effect="non-scaling-stroke" xml:space="preserve">
    <path id="flash1" d="M368.26,121.27c3.25-3.25,3.36-10.13,3.36-10.13s0.58,6.68,4.04,10.13,c3.46,3.46,8.72,2.88,8.72,2.88s-6.22-0.41-8.53,1.89s-3.35,10.23-3.35,10.23s-0.14-6.41-3.67-9.95c-3.54-3.54-9.21-3.19-9.21-3.19,S366.08,123.46,368.26,121.27z"/>
    <path id="flash2" d="M556,345.59c5.5,5.5,17.17,5.7,17.17,5.7s-11.31,0.99-17.17,6.85c-5.86,5.86-4.87,14.77-4.87,14.77,s0.7-10.54-3.21-14.45c-3.91-3.91-17.34-5.67-17.34-5.67s10.86-0.23,16.85-6.22s5.41-15.61,5.41-15.61S552.29,341.88,556,345.59z"/>
    <path id="flash13" d="M817.19,65.22c-3.33-3.33-3.44-10.38-3.44-10.38s-0.6,6.84-4.14,10.38,c-3.54,3.54-8.93,2.95-8.93,2.95s6.37-0.42,8.73,1.94s3.43,10.48,3.43,10.48s0.14-6.56,3.76-10.18s9.43-3.27,9.43-3.27,S819.43,67.46,817.19,65.22z"/>
    <g id="light">
    ...
    <path id="arrow" d="M439.74,262.59c0,0-1.18,11.73-1.93,19.16c-0.75,7.43-2.26,22.45-2.26,22.45l11.39-7.2l6.7,14.65,l8.21-3.6l-7.38-15.66l11.08-4.44l-24.3-24.44"/>
</svg>
