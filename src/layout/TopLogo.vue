...
const locationCss = computed(()=>{
	let pageName = app.routeInfo.name;
	if (pageName == "main") return "is-home"
	else return 'is-sub'
})
</script>

<template>
	<div :class="'header-logo '+locationCss">
		<RouterLink class="navi-logo-link" to="/">
			<svg version="1.1" id="respect-likes-header-logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 160 58" style="enable-background:new 0 0 160 58;" xml:space="preserve">
...
.header-logo .navi-logo-link {
	display: inline-block;
	overflow : hidden;
	width:100px;
	height:32px;
	opacity:0;
	animation: cast-in 1s linear 2s forwards;
}
.header-logo.is-home .navi-logo-link {
	pointer-events: none;
}
#respect-likes-header-logo {
	width : 100px;
}
.header-logo #respect-likes-header-logo path {
	transition: fill 500ms;
}
.header-logo.is-sub #respect-likes-header-logo path {
	fill : rgba(255,255,255, 1);
}
.header-logo #respect-likes-header-logo path,
.header-logo.is-home #respect-likes-header-logo path {
	fill : rgba(255,255,255, 0);
}
#respect-likes-header-logo path:nth-child(1) {
	transition-delay: 1000ms;
}
#respect-likes-header-logo path:nth-child(2) {
	transition-delay: 1100ms;
}
#respect-likes-header-logo path:nth-child(3) {
	transition-delay: 1200ms;
}
#respect-likes-header-logo path:nth-child(4) {
	transition-delay: 1300ms;
}
#respect-likes-header-logo path:nth-child(5) {
	transition-delay: 1400ms;
}
#respect-likes-header-logo path:nth-child(6) {
	transition-delay: 1500ms;
}
#respect-likes-header-logo path:nth-child(7) {
	transition-delay: 1600ms;
}
#respect-likes-header-logo path:nth-child(8) {
